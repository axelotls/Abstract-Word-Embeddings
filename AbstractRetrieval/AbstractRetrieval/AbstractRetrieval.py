...
def __main__():
    ...
    while True:
        try:
            ...
            abstracts = open("AbstractRetrieval/Abstracts.txt", "a")
            ...
            win.title("AbstractRetrieval/Abstracts.txt")
            size= 10
            text= ScrolledText(win, width=100, height= 100)
            file = open('AbstractRetrieval/Abstracts.txt')
            data = file.read()
...
def counter(count):
    r_abstracts = open("AbstractRetrieval/Abstracts.txt", "r")
